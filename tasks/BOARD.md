...
| --- | --- | --- | --- | --- | --- | --- | --- |
| T-401 | run_js 代码执行沙箱(Rhino) | ⭐⭐⭐ | done | 2026-09-13 11:30+0800 | 2026-09-13 11:55+0800 | — | JsTool(Rhino 解释模式 + ClassShutter 禁 Java + 5000 万指令/墙钟双限) + Toolsets 注册 + `JsToolTest` 12 用例;待 T-405 接线 |
