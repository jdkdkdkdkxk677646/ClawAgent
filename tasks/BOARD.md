...
| 任务号 | 标题 | 难度 | 状态 | 认领人 | 领取时间 | 交付 commit | 交付摘要 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| T-304 | README / Roadmap 收尾 | ⭐ | done | — | 2026-09-13 10:40+0800 | — | README Roadmap 第三批三项打勾;「Agent 后台任务」版本标注改 v4.3.0;功能清单核对无过时描述 |
| T-305 | v4.3.0 发版准备(CHANGELOG 落版 + 版本号) | ⭐⭐ | done | — | 2026-09-13 10:40+0800 | — | CHANGELOG 新增 `[v4.3.0]` 节(保留 `v4.3.0-alpha.1` 历史);versionCode 15→16 / versionName "4.3.0" |
